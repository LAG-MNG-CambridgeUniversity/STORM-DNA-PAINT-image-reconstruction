...
%% Parameters
DefaultPath   = 'D:\PostDoc Cambridge\DNA_PAINT\DATA\2020_10_08_Stas_Marius_DNA_PAINT_synaptosomes_phys\a4\Analysis'; % some directory
software      = 'thunder'; % 'rapid' or 'thunder' for rapidSTORM or ThunderSTORM reconstructions
area_token    = 'a4'; % e.g. 'a' if files are called 'a1_488.tif', 'a2_488.tif', ...
RefCh_token   = '_647'; % reference channel (e.g. red: '_647')
tformCh_token = {'_568'}; % channel(s) to be transformed
